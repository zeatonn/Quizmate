  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Quizmate!</DialogTitle>
          <DialogDescription>
            <p className="my-2 mt-4 ">
            Are you weary of typical quizzes? Bid farewell to the ordinary and welcome a new era with Quizmate! Our platform transforms the quiz and trivia experience by utilizing the power of artificial intelligence.
            </p>
            <hr />
            <p className="my-2 font-semibold">
              ...
              <div className="grid justify-around grid-cols-4 mt-2 gap-y-3">
                <div className="flex items-center gap-2">
                  <Image
                    alt="aivenconsole"
                    src="https://console.aiven.io/aiven_console_logo.svg"
                    width={35}
                    height={35}
                  />
                  <span className="">aiven CONSOLE</span>
                </div>
                <div className="flex items-center gap-2">
                  <Image
                    alt="nextjs"
